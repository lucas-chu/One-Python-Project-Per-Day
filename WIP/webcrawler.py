...
if __name__ == "__main__":
        ...
        def execute_start_crawl(index):
                maxdepth = int( ("    Enter Max Depth:"))
                maxpages = int( ("    Enter Max Pages:"))
                url =  ("    Enter Web Url:")
        ...
        def execute_cmd(c,index,graph, ranks, searches):
                if c == '1':
                    ...
                    maxentries =  ("    Enter Number of Index Entries to Display (Type a for all):")
                    ...
                    w =  ("    Enter a word to find from the index:")
                    ret = ""
                    if len(ranks) == 0:
                        ranks = compute_ranks(graph)
